package `in`.co.cfcs.digicard.Fragment

import `in`.co.cfcs.digicard.MainActivity.CardDetail
...
class CardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btn_check: Button = view.findViewById(R.id.btn_check)
        ...
        btn_check.setOnClickListener {
            ...
            val intent = Intent (activity, CardDetail::class.java)
